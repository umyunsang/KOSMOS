...
from kosax.tools.mohw.welfare_eligibility_search import handle as mohw_handle
...
from kosax.tools.nfa119.emergency_info_service import handle as nfa_handle
...
class TestNfaFloatDrift:
    ...
    def test_per_item_failure_does_not_kill_entire_call(self, monkeypatch) -> None:
        ...
        """
        monkeypatch.setenv("KOSAX_DATA_GO_KR_API_KEY", "x")
        payload = {
