...
"""T028 + T032 — Tests for kosax.safety._litellm_callbacks.
...
def _patch_moderation_enabled(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import kosax.settings as _settings_mod
...
def test_block_returns_block_decision(
    ...
    from kosax.safety._litellm_callbacks import ModerationBlockError, pre_call
...
def test_pass_returns_allow(
    ...
    from kosax.safety._litellm_callbacks import pre_call
...
def test_moderation_outage_fail_open(
    ...
    import kosax.safety._litellm_callbacks as _cb_mod

    monkeypatch.setattr(_cb_mod, "emit_safety_event", lambda evt: emitted_events.append(evt))

    from kosax.safety._litellm_callbacks import pre_call
    from kosax.safety._models import ModerationWarnedEvent
...
def test_post_call_output_moderation_block(
    ...
    from kosax.safety._litellm_callbacks import ModerationBlockError, post_call
...
def test_post_call_output_moderation_allow(
    ...
    from kosax.safety._litellm_callbacks import post_call
...
def test_emit_safety_event_called_once_on_block(
    ...
    from kosax.safety._litellm_callbacks import ModerationBlockError, pre_call
    from kosax.safety._models import ModerationBlockedEvent
