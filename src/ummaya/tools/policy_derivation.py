...
UMMAYA-invented per-adapter ``auth_level`` / ``pipa_class`` / ``is_irreversible``
...
References:
- ``AdapterRealDomainPolicy`` — ``src/ummaya/tools/models.py``
- Spec 024 ``ToolCallAuditRecord`` invariants — ``src/ummaya/security/audit.py``
- Spec 025 v6 ``compute_permission_tier`` — ``src/ummaya/tools/permissions.py``
- Spec 1636 plugin Q3 — ``src/ummaya/plugins/checks/q3_security.py``
"""
