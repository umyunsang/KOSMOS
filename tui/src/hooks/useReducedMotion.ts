...
// UMMAYA-original: no upstream CC analog (CC has no reduced-motion gate).
...
// deliberately synchronous — NO_COLOR and UMMAYA_REDUCED_MOTION are read once
