...
Strategy
--------
The IPC stdio bridge (`ummaya.ipc.stdio`) reads JSONL frames from stdin and
...
KOROAD API key is configured (``UMMAYA_KOROAD_API_KEY`` or
``UMMAYA_DATA_GO_KR_API_KEY``), the test does NOT automatically become live;
