...
- Spec deliberately treats the audit document as the user-facing artefact; "users" here are UMMAYA Lead + downstream Epic teams, not end users — appropriate for an internal audit Epic.
