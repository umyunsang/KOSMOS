...
// KOSAX_TUI_STREAM_CHUNK_TOKENS (default 20, per research.md D-3).
//
...
// KOSAX adaptation: token-budget batching replaces CC's streaming accumulator;
...
function getChunkTokens(): number {
  const raw = process.env['KOSAX_TUI_STREAM_CHUNK_TOKENS'];
  if (raw) {
 ...
 * - `KOSAX_TUI_STREAM_CHUNK_TOKENS` overrides the default chunk size.
 */
