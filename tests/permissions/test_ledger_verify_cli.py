...
"""Contract tests for ``ummaya-permissions verify`` — V-matrix scenarios.
...
from ummaya.permissions.ledger_verify import verify_ledger
...
def test_v10_key_file_mode_mismatch(tmp_path: Path) -> None:
    ...
    from ummaya.permissions.hmac_key import HMACKeyFileModeError
...
# Note: V12 CLI test removed in Epic δ #2295 — ummaya.permissions.cli deleted as
# Spec 033 UMMAYA-invented residue. The CLI gate logic is not part of Spec 035
# receipt set.
