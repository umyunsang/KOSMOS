...
COLS="${UMMAYA_DEBUG_COLS:-180}"
ROWS="${UMMAYA_DEBUG_ROWS:-60}"
TMUX_SESSION="ummaya-debug-$$"
SAMPLE_FRAMES="${UMMAYA_TMUX_SAMPLE_FRAMES:-1}"
SAMPLE_INTERVAL="${UMMAYA_TMUX_SAMPLE_INTERVAL:-0.15}"
MAX_FRAMES="${UMMAYA_TMUX_MAX_FRAMES:-500}"
SAMPLER_PID=""
FRAME_SEQ=0
LAST_FRAME_HASH=""
