...
// Emits kosax.ui.surface=export (FR-037).
//
...
function buildOutputPath(): string {
  ...
  return join(getDefaultDownloadPath(), `kosax-export_${timestamp}.pdf`);
}
 ...
 *
 * Emits `kosax.ui.surface=export` (FR-037) and returns the data to render
