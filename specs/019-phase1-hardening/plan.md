...
| FR-010 (default sampling/generation parameters) | Provider-side | HF K-EXAONE README (official recommendations) | — | `temperature=1.0`, `top_p=0.95`, `presence_penalty=0.0`, `max_tokens=1024`, `enable_thinking=False`; all overridable by explicit caller argument. |
