...
**Input model**: `KoroadAccidentSearchInput` defined at `src/kosmos/tools/koroad/koroad_accident_search.py`.
...
**Output model**: `KoroadAccidentSearchOutput` defined at `src/kosmos/tools/koroad/koroad_accident_search.py`.
...
KOSMOS: 강남구(서울특별시)의 2024년 교통사고 사고다발구역 조회 결과입니다. 총 3개 위험지점이 확인되었으며,
