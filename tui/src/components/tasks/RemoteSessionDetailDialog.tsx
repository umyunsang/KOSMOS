...
// KOSAX-1633 P1+P2 / KOSAX-1978 T011 — utils/teleport deleted.
const teleportResumeCodeSession = async (..._args: unknown[]): Promise<{ success: boolean; sessionId?: string; error?: string }> => ({ success: false, error: 'KOSAX: teleport disabled' });
