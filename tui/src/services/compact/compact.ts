...
// KOSAX: services/api/claude.js deleted by Spec 1633 P1+P2.
...
// KOSAX Spec 1633 / Epic #2293 — services/api/{errors,promptCacheBreakDetection,withRetry} deleted; inline stubs preserve call sites.
...
// KOSAX: services/internalLogging.js deleted by Spec 1633 P1. logPermissionContextForAnts → no-op.
