...
from kosax.primitives.verify import SimpleAuthModuleContext, register_verify_adapter
...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.kosax.gov.kr/v1/verify/simple_auth"
