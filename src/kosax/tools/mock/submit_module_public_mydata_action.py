...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.kosax.gov.kr/v1/submit/public-mydata/action"
...
async def invoke(params: dict[str, Any]) -> SubmitOutput:
    ...
    from kosax.memdir.consent_ledger import FileLedgerReader  # noqa: PLC0415
    from kosax.primitives.delegation import revoked_for_session  # noqa: PLC0415
