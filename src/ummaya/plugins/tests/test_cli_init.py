...
"""Tests for the ``ummaya-plugin-init`` Python fallback CLI.
...
class TestRunInitHappyPath:
    ...
    def test_manifest_yaml_round_trips(self, tmp_path: Path) -> None:
        ...
        assert manifest["otel_attributes"]["ummaya.plugin.id"] == "demo_plugin"
...
class TestEntryPointWiring:
    def test_entry_point_function_present(self) -> None:
        # pyproject.toml maps `ummaya-plugin-init = "ummaya.plugins.cli_init:main"`.
