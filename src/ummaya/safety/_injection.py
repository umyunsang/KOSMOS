...
"""Indirect prompt-injection detector for UMMAYA tool outputs.
...
from ummaya.safety._models import InjectionSignalSet
from ummaya.safety._patterns import _INJECTION_PATTERNS, EXPECTED_LEN
...
def run_detector(text: str) -> InjectionSignalSet:
    ...
    Returns an :class:`~ummaya.safety._models.InjectionSignalSet` with the
