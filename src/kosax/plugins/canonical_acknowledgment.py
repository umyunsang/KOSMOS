...
def _load_security_review_md(path: Path | None = None) -> str:
    ...
    2. Wheel-bundled ``kosax/_canonical/security-review.md`` via
    ...
    # 1. Wheel-bundled resource (kosax/_canonical/security-review.md).
    try:
        bundled = resources.files("kosax._canonical").joinpath("security-review.md")
    ...
    raise CanonicalAcknowledgmentLoadError(
        ...
        "kosax/_canonical/security-review.md (wheel resource), "
