# Quickstart — KOSAX System Prompt Redesign (Epic #2152)
...
How a developer working on KOSAX would touch the new prompt-assembly surface, after Epic #2152 ships.
...
# <role>
# 당신은 KOSAX, 한국 공공 서비스 AI 어시스턴트입니다 ...
# </role>
#
# <core_rules>
# - 항상 한국어로 응답합니다 ...
...
- Assembler module: `src/kosax/llm/prompt_assembler.py` (new)
- Tool inventory augmentation: `src/kosax/llm/system_prompt_builder.py` (R6 extension)
- IPC wiring: `src/kosax/ipc/stdio.py:_handle_chat_request` (R3 + R4 wiring)
...
- Anthropic prompt-engineering guide (cached): `~/.claude/projects/-Users-um-yunsang-KOSAX/d2a7266a-45dc-478b-9a8c-7c21f2257281/tool-results/toolu_01AxMFGJ4MYWLbPLWbRt9qju.txt`
