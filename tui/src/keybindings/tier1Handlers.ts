...
// UMMAYA-original — Spec 288 Codex P1 follow-up.
//
...
//   - Backend-bound deps that require an IPC protocol UMMAYA has not yet
...
export type Tier1HandlerDeps = Readonly<{
  ...
  // -------------------------------------------------------------------------
  // UMMAYA Spec 1979 — Spec 033 PermissionMode accessors removed.
  // -------------------------------------------------------------------------
...
export function buildTier1Handlers(
  ...
  // UMMAYA Spec 1979 — Spec 033 permission-mode-cycle removed.
