...
python3 scripts/cc_byte_identical_guard.py \
    ...
    --slice-root tui/src
# expected: "PASS · scanned 454 files · 330 byte-identical · 60 whitelisted · 64 UMMAYA-only · 0 failed"
...
|---|---|
| UMMAYA-only file (e.g. `components/onboarding/Onboarding.tsx`) | PASS — counted as `ummaya_only`. |
