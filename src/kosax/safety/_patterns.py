...
"""Single source of truth for PII detection patterns used across KOSAX safety layers.
...
# well-formed KOSAX adapter response).  Used by the length-deviation signal
