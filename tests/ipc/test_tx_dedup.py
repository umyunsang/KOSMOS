...
- test_cache_state_span_attribute  (asserts kosax.ipc.tx.cache_state="hit")
...
class TestCacheStateSpanAttribute:
    """test_cache_state_span_attribute — kosax.ipc.tx.cache_state is set on OTEL span."""

    def test_miss_sets_span_attribute(self) -> None:
        from unittest.mock import patch

        mock_span = MagicMock()
        with patch("kosax.ipc.tx_cache.trace") as mock_trace:
        ...
        assert calls.get("kosax.ipc.tx.cache_state") == "miss"
    ...
    def test_hit_sets_span_attribute(self) -> None:
        ...
        calls = {call.args[0]: call.args[1] for call in mock_span.set_attribute.call_args_list}
        assert calls.get("kosax.ipc.tx.cache_state") == "hit"
    ...
    def test_bypass_sets_span_attribute(self) -> None:
        ...
        calls = {call.args[0]: call.args[1] for call in mock_span.set_attribute.call_args_list}
        assert calls.get("kosax.ipc.tx.cache_state") == "bypass"
