...
"""Exception hierarchy for the KOSAX Tool System module."""
...
class EnvelopeNormalizationError(KosaxToolError):
...
class RegistrationError(KosaxToolError):
...
class DualAxisMissingError(RegistrationError):
    ...
    Raised by :func:`kosax.security.v12_dual_axis.enforce` when
...
class Layer3GateViolation(KosaxToolError):  # noqa: N818
