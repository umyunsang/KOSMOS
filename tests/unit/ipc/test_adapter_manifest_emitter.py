...
from kosax.ipc.adapter_manifest_emitter import (
    _EXTRA_REGISTRY,
    _build_entries,
    _canonical_json,
    emit_manifest,
...
def test_emit_manifest_exits_78_when_no_entries() -> None:
    ...
    with patch("kosax.ipc.adapter_manifest_emitter._build_entries", return_value=[]):
...
def test_audit4_p0_9_mock_submits_have_policy_url(caplog: pytest.LogCaptureFixture) -> None:
    ...
    from kosax.ipc.adapter_manifest_emitter import _build_entries
    ...
    with caplog.at_level(logging.WARNING, logger="kosax.ipc.adapter_manifest_emitter"):
