...
// UMMAYA-original — Epic #1634 P3 · VerifyPrimitive prompt strings.
...
export const VERIFY_TOOL_PROMPT = `Delegate credential verification to a registered UMMAYA auth adapter.
