...
| Primitive | `lookup` |
| Module | `src/kosax/tools/kma/kma_weather_alert_status.py` |

## Envelope

**Input model**: `KmaWeatherAlertStatusInput` defined at `src/kosax/tools/kma/kma_weather_alert_status.py:58–71`.
...
**Output model**: `KmaWeatherAlertStatusOutput` defined at `src/kosax/tools/kma/kma_weather_alert_status.py:130–140`.
...
KOSAX: 현재 2건의 기상특보가 발효 중입니다. 서울 지역에 호우경보(warn_var=2, warn_stress=1)가, 부산 지역에 태풍 주의보(warn_var=6, warn_stress=0)가 발효 중입니다. 외출 시 주의하시기 바랍니다.
```
