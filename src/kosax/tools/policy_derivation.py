...
KOSAX-invented per-adapter ``auth_level`` / ``pipa_class`` / ``is_irreversible``
...
References:
- ``AdapterRealDomainPolicy`` — ``src/kosax/tools/models.py``
- Spec 024 ``ToolCallAuditRecord`` invariants — ``src/kosax/security/audit.py``
- Spec 025 v6 ``compute_permission_tier`` — ``src/kosax/tools/permissions.py``
- Spec 1636 plugin Q3 — ``src/kosax/plugins/checks/q3_security.py``
"""
