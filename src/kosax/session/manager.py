...
"""High-level session manager for the KOSAX REPL.
...
from kosax.llm.models import ChatMessage, ToolCall
...
class SessionManager:
    """Manages a single KOSAX session with JSONL persistence.
    ...
    async def new_session(self) -> SessionMetadata:
        ...
        :func:`~kosax.session.store.create_session` is now lazy — it returns
        ...
        that :meth:`resume_session` and :func:`~kosax.session.store.list_sessions`
