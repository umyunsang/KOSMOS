...
// Asserts that UMMAYA_TUI_THEME env var controls which token set is exposed.
...
function setThemeEnv(value: string | undefined) {
  if (value === undefined) {
    ...
    process.env['UMMAYA_TUI_THEME'] = value
  }
}

beforeEach(() => {
  savedThemeEnv = process.env['UMMAYA_TUI_THEME']
})
...
describe('ThemeProvider — UMMAYA_TUI_THEME=default', () => {
  it('exposes defaultTheme tokens when UMMAYA_TUI_THEME=default', () => {
    setThemeEnv('default')
...
describe('ThemeProvider — UMMAYA_TUI_THEME=dark', () => {
  it('exposes darkTheme tokens when UMMAYA_TUI_THEME=dark', () => {
    setThemeEnv('dark')
    const { lastFrame } = render(
      <ThemeProvider>
        <ThemeInspector />
...
describe('ThemeProvider — UMMAYA_TUI_THEME=light', () => {
  it('exposes lightTheme tokens when UMMAYA_TUI_THEME=light', () => {
    setThemeEnv('light')
    const { lastFrame } = render(
      <ThemeProvider>
        <ThemeInspector />
...
describe('ThemeProvider — unset UMMAYA_TUI_THEME', () => {
...
describe('ThemeProvider — unknown UMMAYA_TUI_THEME value', () => {
