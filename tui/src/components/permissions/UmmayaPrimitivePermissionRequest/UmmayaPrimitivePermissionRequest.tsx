...
import { aalToLayer, type UmmayaPrimitive } from '../../../utils/permissions/aalToLayer.js'
...
export type UmmayaPrimitivePermissionRequestProps = {
...
// ---------------------------------------------------------------------------
const LOCALE = process.env['UMMAYA_TUI_LOCALE'] ?? 'ko'
...
export function UmmayaPrimitivePermissionRequest({
  primitive,
  toolName,
