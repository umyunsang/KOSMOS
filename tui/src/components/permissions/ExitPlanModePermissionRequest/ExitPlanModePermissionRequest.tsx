...
// Justification: queryHaiku auto-naming requires Anthropic SDK; KOSAX exits plan mode without auto-naming, plan acceptance + permission propagation preserved 1:1.
...
// The component still exits plan mode; session auto-naming is a no-op in KOSAX.
