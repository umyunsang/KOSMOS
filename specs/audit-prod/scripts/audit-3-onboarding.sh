...
# memdir code paths land in the audit jail (not the citizen's real ~/.ummaya):
#   HOME=/tmp/audit-3-home                 — DEFAULT_MEMDIR_ROOT (memdir/io.ts:33)
#                                            consent + ministry-scope writes
#   UMMAYA_MEMDIR_USER=/tmp/audit-3-home/.ummaya/memdir/user
#                                          — uiL2Memdir.ts:25 onboarding state
#                                            + a11y preference
#   UMMAYA_MEMDIR_ROOT=/tmp/audit-3-home/.ummaya/memdir
#                                          — ExportPDFTool root
#
...
# ---------------------------------------------------------------------------
wait_for_pane "환경 점검|preflight|Bun|UMMAYA|ummaya" 60 || true
...
# ---------------------------------------------------------------------------
send_enter_pane
wait_for_pane "UMMAYA v0\.|✻|ummaya|>" 30 || true
