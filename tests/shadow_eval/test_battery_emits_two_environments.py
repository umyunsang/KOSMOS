...
# ---------------------------------------------------------------------------
# Attribute names (KOSAX extension namespace per Spec 021 / FR-D03)
# ---------------------------------------------------------------------------

_ATTR_DEPLOYMENT_ENV = "deployment.environment"
_ATTR_BATTERY_INPUT_ID = "kosax.eval.input_id"
...
async def test_both_environments_share_battery_input_ids(
    ...
    ``kosax.eval.input_id`` attribute values is identical across both runs.
