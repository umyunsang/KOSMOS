...
**Worktree**: `/Users/um-yunsang/UMMAYA-w-2296` on branch `2296-ax-mock-adapters`
...
```text
You are sonnet-<phase-tag> for UMMAYA Epic ε #2296 (AX-infrastructure mock adapters).

Worktree: /Users/um-yunsang/UMMAYA-w-2296
...
- [ ] Worktree clean: `cd /Users/um-yunsang/UMMAYA-w-2296 && git status --short` returns empty
