// UMMAYA Epic #2112: single source-of-truth for the canonical K-EXAONE model id
...
//   - src/ummaya/llm/config.py:37 (Python source-of-truth)
...
export const UMMAYA_K_EXAONE_MODEL = 'LGAI-EXAONE/K-EXAONE-236B-A23B'
export const UMMAYA_K_EXAONE_SHORT = 'k-exaone'
export const UMMAYA_K_EXAONE_DISPLAY = 'K-EXAONE'
