...
**Input model**: `AccidentHazardSearchInput` defined at `src/kosmos/tools/koroad/accident_hazard_search.py`.
...
KOSMOS: 2024년 강남구(adm_cd 1168000000) 교통사고 위험지점 조회 결과, 총 3개 지점이 확인되었습니다.
