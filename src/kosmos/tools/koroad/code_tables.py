...
SIDO_GUGUN_MAP: dict[SidoCode, frozenset[int]] = {
    ...
    SidoCode.BUSAN: frozenset({
        ...
        380, 410, 440, 470, 500, 530, 710,
    }),
    SidoCode.DAEGU: frozenset({
        110, 140, 170, 200, 230, 260, 290, 710,
    }),
    SidoCode.INCHEON: frozenset({
        110, 140, 177, 185, 200, 237, 245, 259, 261, 710, 720,
    }),
    ...
    SidoCode.GYEONGGI: frozenset({
        111, 113, 115, 117, 131, 133, 135, 150, 171, 173,
        191, 193, 195, 210, 220, 250, 271, 273, 281, 285, 287,
        290, 390, 461, 463, 465, 480, 500, 550, 570, 590, 610,
        630, 670, 680, 820, 830, 840,
    }),
    SidoCode.GANGWON_LEGACY: frozenset({
        110, 120, 130, 150, 160, 170, 180, 190, 210,
        720, 730, 750, 760, 770, 780, 790, 800, 810, 820,
    }),
    SidoCode.CHUNGBUK: frozenset({
        110, 130, 140, 150, 720, 730, 740, 745, 750, 760, 770, 780,
    }),
    SidoCode.CHUNGNAM: frozenset({
        110, 130, 140, 150, 160, 720, 725, 730, 740, 745, 750, 760, 770, 800,
    }),
    SidoCode.JEONBUK_LEGACY: frozenset({
        110, 130, 140, 150, 720, 730, 740, 750, 760, 770, 780, 790, 800,
    }),
    SidoCode.JEONNAM: frozenset({
        110, 720, 730, 740, 750, 760, 770, 780, 790, 800, 810, 820, 830, 840,
    }),
    SidoCode.GYEONGBUK: frozenset({
        110, 115, 130, 140, 150, 720, 725, 730, 740, 745, 750, 755,
        760, 770, 780, 790, 800, 810, 820, 830, 840,
    }),
    SidoCode.GYEONGNAM: frozenset({
        110, 125, 127, 129, 131, 133, 720, 725, 730, 740, 745, 750,
        760, 770, 780, 790, 800, 810, 820, 830,
    }),
    SidoCode.JEJU: frozenset({110, 130}),
    SidoCode.GANGWON: frozenset({
        110, 120, 130, 140, 150, 155, 160, 170, 180,
        720, 730, 750, 760, 770, 780, 790, 800, 810, 820,
    }),
    SidoCode.JEONBUK: frozenset({
        110, 113, 130, 140, 150, 720, 730, 740, 750, 760, 770, 780, 790, 800,
    }),
}
