...
def _estimate_tokens(text: str) -> int:
    ...
    Mirrors the formula from kosax.tools._description_template._estimate_tokens:
...
def kma_tools() -> dict[str, Any]:
    ...
    from kosax.tools.kma.kma_current_observation import KMA_CURRENT_OBSERVATION_TOOL
    from kosax.tools.kma.kma_pre_warning import KMA_PRE_WARNING_TOOL
    from kosax.tools.kma.kma_short_term_forecast import KMA_SHORT_TERM_FORECAST_TOOL
    from kosax.tools.kma.kma_ultra_short_term_forecast import KMA_ULTRA_SHORT_TERM_FORECAST_TOOL
    from kosax.tools.kma.kma_weather_alert_status import KMA_WEATHER_ALERT_STATUS_TOOL
...
class TestGridShortReferenceInline:
    ...
    def test_kma_grid_short_reference_is_string(self) -> None:
        ...
        from kosax.tools.kma.grid_coords import kma_grid_short_reference
...
class TestOrderingBlockAbsence:
    ...
    def test_pre_warning_no_ordering(self) -> None:
        ...
        from kosax.tools.kma.kma_pre_warning import KmaPreWarningInput
    ...
    def test_current_observation_triggers_ordering(self) -> None:
        ...
        from kosax.tools.kma.kma_current_observation import KmaCurrentObservationInput
    ...
    def test_short_term_forecast_triggers_ordering(self) -> None:
        ...
        from kosax.tools.kma.kma_short_term_forecast import KmaShortTermForecastInput
    ...
    def test_ultra_short_forecast_triggers_ordering(self) -> None:
        ...
        from kosax.tools.kma.kma_ultra_short_term_forecast import KmaUltraShortTermForecastInput
