"""Mock adapter tree for the active KOSAX primitive harness.
...
Spec 031 US1 submit adapters (T027) — registered with kosax.primitives.submit
on import:
...
# Import triggers self-registration in kosax.primitives.submit._ADAPTER_REGISTRY.
# APPEND ONLY — do not remove or reorder existing entries.
import kosax.tools.mock.data_go_kr.fines_pay  # noqa: F401, E402
import kosax.tools.mock.mydata.welfare_application  # noqa: F401, E402
...
import kosax.tools.mock.submit_module_gov24_minwon  # noqa: F401, E402
import kosax.tools.mock.submit_module_hometax_taxreturn  # noqa: F401, E402
import kosax.tools.mock.submit_module_public_mydata_action  # noqa: F401, E402
...
from kosax.tools.mock import (  # noqa: F401, E402  # noqa: F401, E402
