#!/usr/bin/env bun
/**
 * dump-plugin-frames.tsx — Visual frame dump for KOSAX plugin surfaces.
 *
...
const SAMPLE_PLUGINS: PluginEntry[] = [
  {
    id: 'seoul_subway',
    name: 'kosax-plugin-seoul-subway',
    version: '0.1.0',
