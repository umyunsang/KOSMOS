...
"""Pydantic v2 message and response models for the UMMAYA LLM client."""
...
class StreamEvent(BaseModel):
    ...
    Claude Code reference (``_cc_reference/claude.ts:1979-2304``). UMMAYA
...
class FunctionSchema(BaseModel):
    ...
    # object whose structure is defined by the OpenAI/FriendliAI spec, not by UMMAYA
    # internal I/O contracts. Using Any is the only correct representation.
    parameters: dict[str, Any]

    # Epic #2152 R6 — UMMAYA-internal metadata carrying the per-tool trigger
