...
KOSAX is in early development and has no stable releases yet. Security fixes are applied to the `main` branch only.
...
- Theoretical issues without a reproducible impact on KOSAX
