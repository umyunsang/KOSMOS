...
The existing `src/ummaya/tools/models.py:GovAPITool` already matches Constitution §II defaults. No breaking change; additions:
...
Not a data model per se — a function signature contract implemented in `src/ummaya/tools/envelope.py`:
