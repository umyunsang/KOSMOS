...
/** Placeholder for APIUserMessage from UMMAYA sdk-compat */
export const APIUserMessagePlaceholder = lazySchema(() => z.unknown())

/** Placeholder for APIAssistantMessage from UMMAYA sdk-compat */
export const APIAssistantMessagePlaceholder = lazySchema(() => z.unknown())

/** Placeholder for RawMessageStreamEvent from UMMAYA sdk-compat */
