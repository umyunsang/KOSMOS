...
* The vendored-binary discovery rule: ``--vendor-slsa-from <path>``
  override → ``UMMAYA_PLUGIN_VENDOR_ROOT/slsa-verifier/<platform>/slsa-verifier``
    ...
    *,
    ...
    Args:
        ...
        source_uri: Expected source URI claim
            (e.g. ``github.com/ummaya-plugin-store/ummaya-plugin-<name>``).
    ...
    if not binary.is_file():
        ...
        return SLSAVerificationResult(
            ...
            stderr_tail=(
                ...
                "platform-specific binary into UMMAYA_PLUGIN_VENDOR_ROOT."
            ),
            exit_code=-1,
        )
