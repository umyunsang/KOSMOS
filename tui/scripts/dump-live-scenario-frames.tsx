...
// KOSAX KSC 2026 presentation — Live-only scenario frame dump.
//
...
// Each scenario fans out across 4 ministries to demonstrate KOSAX's
// 부처 횡단 차별점 directly.
...
const SCENARIO_ROAD: readonly ScenarioStep[] = [
  ...
  {
    slug: '도로안전/05-kosax-response',
    description: '도로 안전 — KOSAX 통합 응답 (부처 횡단)',
    element: withTheme(
      <KosaxResponse
        title="응답 (4 부처 통합)"
        lines={[
...
const SCENARIO_HOSPITAL: readonly ScenarioStep[] = [
  ...
  {
    slug: '병원검색/05-kosax-response',
    description: '병원 검색 — KOSAX 통합 응답',
    element: withTheme(
      <KosaxResponse
        title="응답 (3 부처 통합)"
        lines={[
