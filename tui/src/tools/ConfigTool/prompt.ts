...
export const DESCRIPTION = 'Get or set UMMAYA configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set UMMAYA configuration settings.

  View or change UMMAYA settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in the user settings file)
${globalSettings.join('\n')}
