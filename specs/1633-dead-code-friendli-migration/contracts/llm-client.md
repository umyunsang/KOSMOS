...
export class LLMClient {
  constructor(opts: { bridge: IPCBridge; model: string /* = 'LGAI-EXAONE/EXAONE-236B-A23B' */; sessionId: string });
...
- **G3** The `model` constructor argument MUST be `'LGAI-EXAONE/EXAONE-236B-A23B'` in production builds. Tests may pass a mock value.
