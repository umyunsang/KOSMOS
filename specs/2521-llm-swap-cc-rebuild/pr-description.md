...
| `3139e4c` | swap/anti-anthropic-1p | T012 — file-header documentation of 1P call-graph deadening (KOSAX support modules already inert via Spec 1633 stubs) |
| `07d23f8` | swap/identifier-rename | T013 — 2 doc-comment brand tokens (Anthropic/Claude Code → upstream/KOSAX) |
...
| CC stream-event | KOSAX handler | Status |
|---|---|---|
...
| `content_block_delta` text_delta (2113) | byte-copy + `tui/src/ipc/llmClient.ts:411-415` + `src/kosax/llm/client.py:786` | byte-copied + live |
| `content_block_delta` thinking_delta (2148) | byte-copy + `tui/src/ipc/llmClient.ts:398-407` + `src/kosax/llm/client.py:802` | byte-copied + live |
| `content_block_delta` input_json_delta (2087) | byte-copy + `src/kosax/llm/client.py:805` | byte-copied (collapsed at IPC) |
...
| `server_tool_use` (2003) | (skipped) | KOSAX-N/A |
| `signature_delta` (2127) | (skipped) | KOSAX-N/A |
| `citations_delta` (2084) | (skipped) | KOSAX-N/A |
| `connector_text_delta` (2068) | (skipped) | KOSAX-N/A |
