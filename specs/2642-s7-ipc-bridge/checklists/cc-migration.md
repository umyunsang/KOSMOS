...
**Source**: `.specify/memory/constitution.md` (project-wide hard rules) + `AGENTS.md § Hard rules` + `docs/requirements/ummaya-migration-tree.md`.
...
| Env vars prefixed `UMMAYA_` | ✅ | New env: `UMMAYA_IPC_PARITY_DRIFT_FIXTURE` (test-only) |
...
## CC-Migration alignment (ummaya-migration-tree.md)
