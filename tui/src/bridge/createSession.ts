...
export async function createBridgeSession({
  ...
  const getOauthConfig = (): { BASE_API_URL: string } => ({ BASE_API_URL: '' }) /* KOSAX-1633: oauth deleted */
  const getOAuthHeaders = (_token?: string): Record<string, string> => ({}) /* KOSAX-1633 P1+P2 / KOSAX-1978 T011 — utils/teleport deleted */
