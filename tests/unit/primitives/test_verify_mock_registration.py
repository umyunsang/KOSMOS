...
Asserts that importing kosax.tools.mock registers all 6 verify family adapters
into kosax.primitives.verify._VERIFY_ADAPTERS, that each adapter is callable,
...
class TestVerifyMockRegistration:
    """After importing kosax.tools.mock, _VERIFY_ADAPTERS must be populated."""

    def test_at_least_two_families_registered(self) -> None:
        import kosax.tools.mock  # noqa: F401 — side-effect: registers adapters
