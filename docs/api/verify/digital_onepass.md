...
| Primitive | `verify` |
| Module | `src/kosax/tools/mock/verify_digital_onepass.py` |
...
**Output model**: `DigitalOnepassContext` defined at `src/kosax/primitives/verify.py:170–183`.
...
```text
시민: 디지털원패스로 본인인증 해줘.
KOSAX: 디지털원패스 Level 2 (AAL2) 인증이 확인되었습니다. 인증 시각: 2026-04-19 09:00 UTC, 세션 참조: mock-onepass-ref-001.
```
