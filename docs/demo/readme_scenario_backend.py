...
SCENARIOS: tuple[Scenario, ...] = (
    Scenario(
        ...
        title="Tax execution",
        tool_chain=(
            ("check", "mock_verify_module_modid"),
            ("find", "mock_lookup_module_hometax_simplified"),
            ("send", "mock_submit_module_hometax_taxreturn"),
        ),
    ...
    Scenario(
        ...
        tool_chain=(
            ("check", "mock_verify_module_simple_auth"),
            ("locate", "locate"),
    ...
    Scenario(
        ...
        tool_chain=(
            ("check", "mock_verify_module_ganpyeon"),
            ("find", "mock_traffic_fine_lookup_v1"),
            ("send", "mock_traffic_fine_pay_v1"),
        ),
    ...
    Scenario(
        ...
        tool_chain=(
            ("locate", "locate"),
            ("find", "nmc_emergency_search"),
            ("find", "hira_hospital_search"),
        ),
    ...
    Scenario(
        ...
        tool_chain=(
            ("locate", "locate"),
            ("find", "kma_forecast_lookup"),
            ("find", "koroad_accident_hazard_search"),
            ("find", "mock_safety_alert_watch"),
        ),
    ...
    Scenario(
        ...
        tool_chain=(
            ("check", "mock_verify_mobile_id"),
            ("find", "mock_cbs_disaster_feed"),
            ("send", "mock_submit_module_gov24_minwon"),
            ("find", "mock_safety_alert_watch"),
        ),
    ...
    Scenario(
        ...
        tool_chain=(
            ("check", "mock_verify_mydata"),
            ("find", "mock_public_mydata_inventory"),
            ("send", "mock_submit_module_gov24_minwon"),
        ),
