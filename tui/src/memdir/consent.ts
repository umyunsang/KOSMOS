...
// Source: KOSAX Epic H #1302 (035-onboarding-brand-port), task T020
// Contract: specs/035-onboarding-brand-port/contracts/memdir-consent-schema.md § 3
//
// Zod mirror of the Python `PIPAConsentRecord` model (src/kosax/memdir/
 ...
 * `src/kosax/memdir/user_consent.py::CURRENT_CONSENT_VERSION`.  Bump both
 * in the same PR.
 */
