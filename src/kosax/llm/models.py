...
"""Pydantic v2 message and response models for the KOSAX LLM client."""
...
class StreamEvent(BaseModel):
    ...
    Claude Code reference (``_cc_reference/claude.ts:1979-2304``). KOSAX
...
class FunctionSchema(BaseModel):
    ...
    # object whose structure is defined by the OpenAI/FriendliAI spec, not by KOSAX
    # internal I/O contracts. Using Any is the only correct representation.
    parameters: dict[str, Any]

    # Epic #2152 R6 — KOSAX-internal metadata carrying the per-tool trigger
