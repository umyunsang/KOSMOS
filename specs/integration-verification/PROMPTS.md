...
```
cd /Users/um-yunsang/KOSAX/tui && KOSAX_ONBOARDING_AUTO_COMPLETE=1 bun run tui
```
- 예외: vhs-08 onboarding 은 `rm -rf ~/.kosax/memdir/user/onboarding && cd … && bun run tui` (env 변수 없이)
