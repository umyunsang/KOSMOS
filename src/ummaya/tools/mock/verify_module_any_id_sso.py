...
from ummaya.primitives.delegation import IdentityAssertion
from ummaya.primitives.verify import AnyIdSsoContext, register_verify_adapter
...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.ummaya.gov.kr/v1/verify/any_id_sso"
