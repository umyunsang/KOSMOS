...
COLS="${KOSAX_DEBUG_COLS:-180}"
ROWS="${KOSAX_DEBUG_ROWS:-60}"
TMUX_SESSION="kosax-debug-$$"
SAMPLE_FRAMES="${KOSAX_TMUX_SAMPLE_FRAMES:-1}"
SAMPLE_INTERVAL="${KOSAX_TMUX_SAMPLE_INTERVAL:-0.15}"
MAX_FRAMES="${KOSAX_TMUX_MAX_FRAMES:-500}"
SAMPLER_PID=""
FRAME_SEQ=0
LAST_FRAME_HASH=""
