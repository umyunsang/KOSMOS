...
class TestHandleMocked:
    ...
    async def test_handle_injects_calltP_and_srch_key_code(self, monkeypatch) -> None:
        ...
        monkeypatch.setenv("UMMAYA_DATA_GO_KR_API_KEY", _FAKE_API_KEY)
...
class TestMohwV4LifeArray007Live:
    ...
    Requires UMMAYA_DATA_GO_KR_API_KEY to be set.
    Evidence: /tmp/ummaya-evidence/koroad-mohw-evidence.md (totalCount=21 for lifeArray=007).
    """
...
class TestMohwV4Description:
    ...
    def test_output_schema_is_envelope_placeholder(self) -> None:
        ...
        """
        from ummaya.tools.mohw.welfare_eligibility_search import _MohwPlaceholderOutput
