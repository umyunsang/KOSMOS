...
"""Exception hierarchy for the UMMAYA Tool System module."""
...
class EnvelopeNormalizationError(UmmayaToolError):
...
class RegistrationError(UmmayaToolError):
...
class DualAxisMissingError(RegistrationError):
    ...
    Raised by :func:`ummaya.security.v12_dual_axis.enforce` when
...
class Layer3GateViolation(UmmayaToolError):  # noqa: N818
