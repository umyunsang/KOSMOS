...
Korean Hangul subset of NanumGothic Regular for KOSAX PDF export (`/export`).
...
Subsetted version is 952 KB. Coverage verified against realistic KOSAX Korean text including
