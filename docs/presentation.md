...
> 각 인용 끝의 페이지 번호 (예: [p.97][p97]) 를 클릭하면 브라우저 PDF 뷰어에서 해당 페이지로 바로 이동합니다 (Chrome/Safari/Firefox 기본 PDF 뷰어 기준 — GitHub 내장 뷰어와 `raw.githubusercontent.com`은 페이지 앵커를 지원하지 않거나 강제 다운로드되므로, jsDelivr CDN을 경유해 인라인으로 서빙합니다).
...
>
> — 국가인공지능전략위원회, 『대한민국 인공지능 행동계획』, 2026.2.25, [p.97][p97] (전략분야 7 공공AX, 과제 58 — 원칙 9)
...
>
> — 국가인공지능전략위원회, 『대한민국 인공지능 행동계획』, 2026.2.25, [p.85][p85] (전략분야 7 공공AX 비전)
...
>
> — 같은 자료, [p.14-15][p14] (전략분야 1 — AI 안전·신뢰)
...
>
> — 같은 자료, [p.133][p133] (전략분야 11 AI 기본사회 비전)
...
[p14]: https://cdn.jsdelivr.net/gh/umyunsang/KOSMOS@main/docs/references/korea-ai-action-plan-2026-2028.pdf#page=14
[p85]: https://cdn.jsdelivr.net/gh/umyunsang/KOSMOS@main/docs/references/korea-ai-action-plan-2026-2028.pdf#page=85
[p96]: https://cdn.jsdelivr.net/gh/umyunsang/KOSMOS@main/docs/references/korea-ai-action-plan-2026-2028.pdf#page=96
[p97]: https://cdn.jsdelivr.net/gh/umyunsang/KOSMOS@main/docs/references/korea-ai-action-plan-2026-2028.pdf#page=97
[p133]: https://cdn.jsdelivr.net/gh/umyunsang/KOSMOS@main/docs/references/korea-ai-action-plan-2026-2028.pdf#page=133
