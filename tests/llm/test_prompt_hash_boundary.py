...
"""Tests for the kosax.prompt.hash boundary-marker slicing (Epic #2152 R4).
...
def _hash_static_prefix(system_text: str) -> str:
    """Re-implementation mirroring kosax.llm.client._compute_prompt_hash logic.
...
def test_production_client_uses_same_logic() -> None:
    ...
    from kosax.llm import client as _client_module
    ...
    assert "kosax.prompt.hash" in text
