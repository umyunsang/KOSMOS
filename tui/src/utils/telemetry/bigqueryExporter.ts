...
// backend) is permanently disabled in UMMAYA. instrumentation.ts byte-copy (R-5)
// references this module; UMMAYA exports to local Langfuse via OTLP (Spec 021/028).
...
export class BigQueryMetricsExporter implements Partial<MetricReader> {
  ...
  // UMMAYA routes metrics via @opentelemetry/exporter-metrics-otlp-http to local
