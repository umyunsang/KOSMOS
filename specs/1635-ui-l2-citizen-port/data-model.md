...
Persisted at `~/.ummaya/memdir/user/onboarding/state.json`. Owned by this epic.
...
Persisted at `~/.ummaya/memdir/user/preferences/a11y.json`. New path owned by this epic (D-5 in `research.md`).
