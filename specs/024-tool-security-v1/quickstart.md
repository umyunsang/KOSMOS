...
**Audience**: KOSAX contributors (human or agent) shipping a tool adapter after this spec lands.
...
from kosax.security.audit import ToolCallAuditRecord
...
| `GovAPITool` field extensions | `src/kosax/tools/models.py` | 4 new fields added, validators wired |
| `ToolCallAuditRecord` model | `src/kosax/security/audit.py` | New module, schema-only (no storage) |
