...
"""Micro-compact engine for UMMAYA Context Assembly layer.
...
variant).  UMMAYA v1 uses only the simpler content-clear approach.
"""
...
def _dedup_system_messages(
    ...
    In UMMAYA the system message is the very first element in the list.
