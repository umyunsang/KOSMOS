...
"""Indirect prompt-injection detector for KOSAX tool outputs.
...
from kosax.safety._models import InjectionSignalSet
from kosax.safety._patterns import _INJECTION_PATTERNS, EXPECTED_LEN
...
def run_detector(text: str) -> InjectionSignalSet:
    ...
    Returns an :class:`~kosax.safety._models.InjectionSignalSet` with the
