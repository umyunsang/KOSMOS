...
Reference: Spec 022 (`ummaya.tools.lookup.lookup()`) — the actual routing
...
from ummaya.memdir.ministry_scope import (
...
# registered in `src/ummaya/tools/register_all.py`.
