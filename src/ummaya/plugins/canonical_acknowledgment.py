...
def _load_security_review_md(path: Path | None = None) -> str:
    ...
    2. Wheel-bundled ``ummaya/_canonical/security-review.md`` via
    ...
    # 1. Wheel-bundled resource (ummaya/_canonical/security-review.md).
    try:
        bundled = resources.files("ummaya._canonical").joinpath("security-review.md")
    ...
    raise CanonicalAcknowledgmentLoadError(
        ...
        "ummaya/_canonical/security-review.md (wheel resource), "
