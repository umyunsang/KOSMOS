...
| 10 | live launch — reduced motion | DEFERRED | Covered by LogoV2.snap.test.tsx 6-cell matrix (3 cols × 2 motion states) + AnimatedAsterisk / WelcomeV2 / KosaxCoreIcon tests. |
