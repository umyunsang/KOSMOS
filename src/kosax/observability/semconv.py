...
"""OpenTelemetry GenAI semantic convention constants for KOSAX.
...
single source of truth across all KOSAX instrumentation code.
...
__all__ = [
    ...
    "GEN_AI_USAGE_OUTPUT_TOKENS",
    # --- Agent Swarm (Epic #13) ---
    "KOSAX_AGENT_COORDINATOR_PHASE",
    "KOSAX_AGENT_ROLE",
    "KOSAX_AGENT_SESSION_ID",
    "KOSAX_AGENT_MAILBOX_MSG_TYPE",
    "KOSAX_AGENT_MAILBOX_CORRELATION_ID",
    "KOSAX_AGENT_MAILBOX_SENDER",
    "KOSAX_AGENT_MAILBOX_RECIPIENT",
]
...
# All names are in the kosax.agent.* namespace per spec/027 data-model.md §8.
# ---------------------------------------------------------------------------

KOSAX_AGENT_COORDINATOR_PHASE: str = "kosax.agent.coordinator.phase"
...
KOSAX_AGENT_ROLE: str = "kosax.agent.role"
...
KOSAX_AGENT_SESSION_ID: str = "kosax.agent.session_id"
...
KOSAX_AGENT_MAILBOX_MSG_TYPE: str = "kosax.agent.mailbox.msg_type"
...
KOSAX_AGENT_MAILBOX_CORRELATION_ID: str = "kosax.agent.mailbox.correlation_id"
...
KOSAX_AGENT_MAILBOX_SENDER: str = "kosax.agent.mailbox.sender"
...
KOSAX_AGENT_MAILBOX_RECIPIENT: str = "kosax.agent.mailbox.recipient"
