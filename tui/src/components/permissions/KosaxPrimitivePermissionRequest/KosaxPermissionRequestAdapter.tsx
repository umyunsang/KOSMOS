...
// Epic 1 finish — CC switch arm adapter for KOSAX primitives.
//
...
// KOSAX `KosaxPrimitivePermissionRequestProps` interface.
//
...
// KOSAX adaptation: wraps onAllow / onReject callbacks to satisfy both the
//   CC pipeline (toolUseConfirm.onAllow / onReject) and the KOSAX modal API
//   (onDecision). receipt_id is surfaced in the footer via
//   context.kosax_receipt_id injected by the backend echo frame handler.

import React, { useCallback } from 'react'
import { resolveAdapter } from '../../../services/api/adapterManifest.js'
import type { PermissionRequestProps } from '../PermissionRequest.js'
import type { PrimitiveDecision } from './KosaxPrimitivePermissionRequest.js'
import { KosaxPrimitivePermissionRequest } from './KosaxPrimitivePermissionRequest.js'
...
/**
 * Maps a KOSAX PrimitiveDecision to the CC `onAllow` / `onReject` callbacks.
