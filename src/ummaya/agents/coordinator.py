...
from ummaya.observability.semconv import UMMAYA_AGENT_COORDINATOR_PHASE
...
class Coordinator:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            max_workers: Maximum concurrent worker tasks (UMMAYA_AGENT_MAX_WORKERS).
            worker_timeout_seconds: Per-worker timeout (UMMAYA_AGENT_WORKER_TIMEOUT_SECONDS).
        """
    ...
    def spawn_worker(self, specialist_role: str) -> AgentContext:
        ...
        and respects UMMAYA_AGENT_MAX_WORKERS cap (via semaphore in _research_phase).
    ...
    def _emit_phase_span(self, phase: CoordinatorPhase) -> None:
        ...
        with _tracer.start_as_current_span(span_name) as span:
            span.set_attribute(UMMAYA_AGENT_COORDINATOR_PHASE, phase.value)
