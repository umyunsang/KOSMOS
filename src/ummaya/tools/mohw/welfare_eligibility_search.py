...
Evidence: /tmp/ummaya-evidence/koroad-mohw-evidence.md (lifeArray=007 → 21 services live).
...
from ummaya.tools.mohw._short_references import (
...
def _parse_xml_response(xml_bytes: bytes) -> dict[str, Any]:
    ...
    Live SSIS envelope (verified 2026-05-04 with UMMAYA_DATA_GO_KR_API_KEY):
        <wantedList>
