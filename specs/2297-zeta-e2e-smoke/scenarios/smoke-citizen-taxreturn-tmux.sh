...
#
# NOTE on KOSAX_SMOKE_CHECKPOINTS:
...
#   reads KOSAX_* from the caller's environment. Export this before invoking:
#     KOSAX_SMOKE_CHECKPOINTS=true scripts/tui-tmux-capture.sh ...
...
# fixture injection (KOSAX_SMOKE_CHECKPOINTS=true + fixture wired in §P0).
