...
from kosax.tools.errors import AdapterIdCollisionError, DuplicateToolError
...
def test_collision_exposes_existing_module_metadata() -> None:
    ...
    # GovAPITool lives under kosax.tools.models; existing_module MUST reflect that.
    assert exc_info.value.existing_module == "kosax.tools.models"
