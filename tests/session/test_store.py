...
"""Tests for kosax.session.store — JSONL read/write, corruption handling, directory creation."""
...
# ---------------------------------------------------------------------------
# KOSAX_SESSION_DIR tilde expansion
# ---------------------------------------------------------------------------


class TestSessionDirTildeExpansion:
    """Verify that KOSAX_SESSION_DIR values containing '~' are expanded."""
    ...
    def test_tilde_in_env_var_is_expanded(
        ...
        home directory, then set KOSAX_SESSION_DIR to a '~/...' string.
        ...
        monkeypatch.setenv("KOSAX_SESSION_DIR", "~/kosax-test-sess")
