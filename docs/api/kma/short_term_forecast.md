...
| Primitive | `lookup` |
| Module | `src/kosax/tools/kma/kma_short_term_forecast.py` |

## Envelope

**Input model**: `KmaShortTermForecastInput` defined at `src/kosax/tools/kma/kma_short_term_forecast.py:43-91`.
...
**Output model**: `KmaShortTermForecastOutput` defined at `src/kosax/tools/kma/kma_short_term_forecast.py:130-140`.
...
KOSAX: 2026년 4월 26일 오전 11시 기준 서울(격자 61, 125) 단기예보입니다. 오후 12시 기온은 19°C로 예상되며 강수확률은 10%입니다. 비 올 가능성은 낮습니다. 전체 3일 예보는 총 290개 항목이 있으며 페이지를 늘려 조회할 수 있습니다.
```
