...
"""Tests for the ``kosax-plugin-init`` Python fallback CLI.
...
class TestRunInitHappyPath:
    ...
    def test_manifest_yaml_round_trips(self, tmp_path: Path) -> None:
        ...
        assert manifest["otel_attributes"]["kosax.plugin.id"] == "demo_plugin"
...
class TestEntryPointWiring:
    def test_entry_point_function_present(self) -> None:
        # pyproject.toml maps `kosax-plugin-init = "kosax.plugins.cli_init:main"`.
