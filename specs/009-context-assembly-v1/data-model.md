...
**Location**: `src/kosax/context/models.py`
**Date**: 2026-04-13
...
**Module**: `src/kosax/context/models.py`
...
|---|---|---|---|---|
| `platform_identity` | `str` | `"KOSAX"` | non-empty | Injected into the platform identity section |
...
**Module**: `src/kosax/engine/models.py`
...
All token estimates in `ContextLayer.estimated_tokens` and the tool-definition estimate use `kosax.engine.tokens.estimate_tokens()`:
