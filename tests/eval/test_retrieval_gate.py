...
def _build_registry() -> tuple[object, object]:
    ...
    Delegates to ``kosax.eval.retrieval._build_registry`` which registers
    each seed adapter individually and is resilient to partial availability.
    """
    from kosax.eval.retrieval import _build_registry as eval_build_registry
...
class TestRetrievalGate:
    ...
    def test_recall_gate_with_available_adapters(
        ...
        from kosax.eval.retrieval import _evaluate
