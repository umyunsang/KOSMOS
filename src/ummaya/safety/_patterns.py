...
"""Single source of truth for PII detection patterns used across UMMAYA safety layers.
...
# well-formed UMMAYA adapter response).  Used by the length-deviation signal
