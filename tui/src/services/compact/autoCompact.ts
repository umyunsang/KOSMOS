...
// UMMAYA: services/api/claude.js deleted by Spec 1633 P1+P2. getMaxOutputTokensForModel → 8192 default.
const getMaxOutputTokensForModel = (_model: string): number => 8192
// UMMAYA Spec 1633 / Epic #2293 — services/api/promptCacheBreakDetection deleted (Anthropic prompt-cache); inline no-op stub.
