...
// KOSAX-original: CC OAuth config not used — FriendliAI uses token auth.
...
// KOSAX-original: CC macOS keychain not used — no-op.
...
// KOSAX-original: CC claude.ai MCP tracking not used — no-op.
