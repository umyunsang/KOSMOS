...
from ummaya.memdir.consent_ledger import DelegationIssuedEvent, append_delegation_issued
from ummaya.primitives.delegation import DelegationContext, DelegationToken
from ummaya.primitives.verify import KECContext, register_verify_adapter
...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.ummaya.gov.kr/v1/verify/kec"
