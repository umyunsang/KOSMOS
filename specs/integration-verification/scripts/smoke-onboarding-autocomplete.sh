#!/usr/bin/env bash
# Onboarding KOSAX_ONBOARDING_AUTO_COMPLETE=1 escape hatch verification
...
set -euo pipefail
wait_for_pane "KOSAX v0\\.[0-9]|환경 점검" 30
snapshot_pane "boot-or-onboarding"
sleep 4
snapshot_pane "after-autocomplete"
wait_for_pane "KOSAX v0\\.[0-9]" 15 || snapshot_pane "no-repl-yet"
