...
**License**: Proprietary SDK with public documentation; UMMAYA mock is an independent re-implementation based solely on the publicly documented API shape — not a derivative of the SDK source
...
- Device biometric verification — out of scope; UMMAYA only consumes the `signedData` result
