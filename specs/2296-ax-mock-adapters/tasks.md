...
- [X] T024 [P] [US1] Implement `src/ummaya/tools/mock/submit_module_gov24_minwon.py` per same pattern. Constants: `_INTERNATIONAL_REF = "Singapore APEX"`, scope `"submit:gov24.minwon"`. Add `tests/unit/tools/test_mock_submit_module_gov24_minwon.py`.
- [X] T025 [P] [US1] Implement `src/ummaya/tools/mock/submit_module_public_mydata_action.py` per same pattern. Constants: `_INTERNATIONAL_REF = "Estonia X-Road"`, `_REFERENCE_IMPL = "public-mydata-action-extension"`, scope `"submit:public_mydata.action"`. Add `tests/unit/tools/test_mock_submit_module_public_mydata_action.py`.
