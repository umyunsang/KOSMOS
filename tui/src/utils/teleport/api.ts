...
export async function prepareApiRequest(): Promise<{
  ...
  if (accessToken === undefined) {
    throw new Error(
      'UMMAYA web sessions require authentication with UMMAYA web access. API key authentication is not sufficient. Please run /login to authenticate, or check your authentication status with /status.',
    )
  }
 ...
 * following the LLM messages spec.
 */
