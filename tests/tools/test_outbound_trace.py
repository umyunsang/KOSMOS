...
"""Unit tests for kosax.tools._outbound_trace (Spec 2521)."""
...
from kosax.tools._outbound_trace import (
    OutboundCallTrace,
...
async def test_kma_forecast_fetch_emits_trace() -> None:
    ...
    from kosax.tools.kma.forecast_fetch import KmaForecastFetchInput, _fetch
    ...
    os.environ.setdefault("KOSAX_DATA_GO_KR_API_KEY", "test-key-only")
