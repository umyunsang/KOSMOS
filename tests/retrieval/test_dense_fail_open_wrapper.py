...
when ``UMMAYA_RETRIEVAL_BACKEND=dense`` and cold-start is ``lazy`` (default),
...
from ummaya.tools.retrieval.backend import _DenseFailOpenWrapper
from ummaya.tools.retrieval.bm25_backend import BM25Backend
from ummaya.tools.retrieval.degrade import DegradationRecord
from ummaya.tools.retrieval.dense_backend import DenseBackend
...
def test_wrapper_satisfies_retriever_protocol() -> None:
    ...
    from ummaya.tools.retrieval.backend import Retriever
