...
"""LiteLLM callback hooks for the UMMAYA content-moderation layer (Layer B).
...
from ummaya.safety._models import ModerationBlockedEvent, ModerationWarnedEvent
...
def _call_moderation_api(content: str) -> tuple[tuple[str, ...], bool]:
    ...
    from ummaya.settings import settings  # noqa: PLC0415 (avoid circular import)
...
def _ensure_enabled() -> bool:
    ...
    from ummaya.settings import settings  # noqa: PLC0415 (avoid circular at module level)
