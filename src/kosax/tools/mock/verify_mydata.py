...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.kosax.gov.kr/v1/verify/mydata"
...
ADAPTER_REGISTRATION = AdapterRegistration(
    ...
    module_path="kosax.tools.mock.verify_mydata",
    input_model_ref="kosax.primitives.verify:VerifyInput",
