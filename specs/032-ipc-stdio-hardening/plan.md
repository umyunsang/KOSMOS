...
**Project Type**: Library extension — modifies existing `src/ummaya/ipc/` + `tui/src/ipc/` packages. No new top-level package.
...
```text
src/ummaya/ipc/                                     # EXTEND existing package
