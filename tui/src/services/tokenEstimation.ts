...
// UMMAYA Epic β #2293 — services/tokenEstimation stub:
 ...
 * UMMAYA uses FriendliAI (no dedicated counting endpoint) — always returns null
 ...
 * UMMAYA has a single fixed model (K-EXAONE on FriendliAI) with no dedicated
