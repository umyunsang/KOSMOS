...
def test_build_verify_session_context_packs_params_shape() -> None:
    ...
    from kosax.ipc.stdio import _build_verify_session_context
...
def test_inject_delegation_context_overwrites_partial_llm_copy() -> None:
    ...
    from kosax.ipc.stdio import _inject_delegation_context
...
def test_bind_submit_session_id_overwrites_llm_value_without_mutation() -> None:
    ...
    from kosax.ipc.stdio import _bind_submit_session_id
...
async def test_mydata_verify_issues_scope_bound_delegation_context(tmp_path) -> None:
    ...
    from kosax.tools.mock.verify_mydata import invoke
...
def test_invalid_gated_primitive_tool_id_result_blocks_blank_tool() -> None:
    ...
    from kosax.ipc.stdio import _invalid_gated_primitive_tool_id_result
...
def test_contains_mock_marker_detects_nested_adapter_receipt() -> None:
    ...
    from kosax.ipc.stdio import _contains_mock_marker
...
def test_ensure_mock_disclosure_appends_once() -> None:
    ...
    from kosax.ipc.stdio import _ensure_mock_disclosure
    ...
    disclosed = _ensure_mock_disclosure(
        "\n".join(
            [
                ...
                "거래 ID: "
                "urn:kosax:submit:807823304ad5dfeb0b4d8b938bf8f493c76ea9f30d2b7abecee3401179faaf84",
                "신청자: 홍길동",
                "수령 방법: 온라인 발급",
    ...
    disclosed = _ensure_mock_disclosure(
        "\n".join(
            [
                ...
                "거래 ID: "
                "urn:kosax:submit:72d28a717acb576351be4106aa78b4a8cd552bd889b6e79b5875242f76b7507b",
                "총 신고 소득: 42,000,000원",
