...
- This module is a **downstream consumer** of Spec 024.  It MUST NOT modify
  ``kosax.security.audit.ToolCallAuditRecord``.
...
Reference:
  ...
  src/kosax/security/audit.py ToolCallAuditRecord
  src/kosax/permissions/models.py ConsentDecision
"""
...
from kosax.permissions.models import ConsentDecision
