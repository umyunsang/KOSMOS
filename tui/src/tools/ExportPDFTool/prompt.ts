 ...
 */
export const EXPORT_PDF_DESCRIPTION = `Export citizen-facing conversation content (summaries, excerpts) to an HTML file saved under the UMMAYA Memdir USER tier (~/.ummaya/memdir/user/exports/).
...
export const EXPORT_PDF_PROMPT = `Export citizen-facing markdown content (conversation excerpts, summaries) as an HTML file under ~/.ummaya/memdir/user/exports/.
