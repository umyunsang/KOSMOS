...
``kosax.tools.resolve_location._sgis_adm_cd``.  It is moved here in
...
async def lookup_adm_cd_by_coords(
    ...
    *,
    ...
    Args:
        ...
        consumer_key: SGIS API consumer key (``KOSAX_SGIS_KEY``).
        consumer_secret: SGIS API consumer secret (``KOSAX_SGIS_SECRET``).
