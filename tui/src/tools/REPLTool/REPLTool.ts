...
// KOSAX-1633 P2 / KOSAX-1978 T009 — stub-noop tool.
//
// Original CC: `tui/src/tools/REPLTool/REPLTool.ts` — Anthropic's Python REPL
// tool for the Code Interpreter feature. KOSAX does not ship a Python REPL
...
export const REPLTool = {
  ...
  description: 'KOSAX-1978: REPLTool not active in citizen TUI.',
