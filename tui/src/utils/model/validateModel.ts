// KOSAX Epic #2112: legacy model-validation API call removed. After the
...
export async function validateModel(
  ...
  // K-EXAONE id and KOSAX_CUSTOM_MODEL_OPTION, which contradicted both the
  ...
  // for KOSAX to ship to FriendliAI; runtime resolution is handled by
