...
"""Core state models for the KOSAX Query Engine (Layer 1).
...
class QueryContext(BaseModel):
    ...
    ``kosax.ipc.correlation_id`` OTEL attribute (FR-027 / FR-053).  ``None``
...
# ---------------------------------------------------------------------------
from kosax.permissions.models import SessionContext  # noqa: E402
