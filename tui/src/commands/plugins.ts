...
//
// Opens the PluginBrowser. Emits kosax.ui.surface=plugins (FR-037).
// Round-trips a plugin_op_request:list frame to the backend dispatcher
// (src/kosax/ipc/plugin_op_dispatcher.py:handle_list) which responds with
...
// schema; kept in sync with src/kosax/ipc/plugin_op_dispatcher.py § list.
// ---------------------------------------------------------------------------
 ...
 *
 * Emits `kosax.ui.surface=plugins` (FR-037) and round-trips a
