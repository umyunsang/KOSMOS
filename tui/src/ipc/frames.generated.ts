...
// Source of truth: src/kosax/ipc/frame_schema.py (Pydantic v2)
...
/**
 * Consent receipt UUID written to ~/.kosax/memdir/user/consent/<id>.json on granted decisions. None on deny / timeout.
 */
...
/**
 * Human-readable short message. MUST NOT contain KOSAX_*-prefixed env var values (FR-004 redaction rule).
 */
...
/**
 * Target receipt identifier (rcpt-<id>). Must match an existing receipt file at ~/.kosax/memdir/user/consent/<receipt_id>.json.
 */
...
/**
 * Structured error details. KOSAX_* env var values MUST be redacted.
 */
