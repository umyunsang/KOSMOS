# Visual Evidence — UMMAYA Plugin Surfaces

> 측정일: 2026-04-26
> 측정자: Lead 자동화 (umyunsang)
>
> ink-testing-library 로 UMMAYA plugin 관련 인터랙티브 UI surface 의 lastFrame() 을 dump 한 시각 검증 산출물. PTY 인 실제 TUI 호스트 없이도 frame 의 정확성을 review 할 수 있도록 plain text + ANSI 양 형식으로 보존.
...
| `pipa-consent-step-en.txt` | English (UMMAYA_TUI_LOCALE=en) |
...
- backend 통합 테스트: `src/ummaya/plugins/tests/test_install_e2e.py` — SC-004 / SC-005 / SC-007 / SC-010 모두 PASS.
