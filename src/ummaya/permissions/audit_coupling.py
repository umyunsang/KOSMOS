...
- This module is a **downstream consumer** of Spec 024.  It MUST NOT modify
  ``ummaya.security.audit.ToolCallAuditRecord``.
...
Reference:
  ...
  src/ummaya/security/audit.py ToolCallAuditRecord
  src/ummaya/permissions/models.py ConsentDecision
"""
...
from ummaya.permissions.models import ConsentDecision
