...
UMMAYA_IPC_* env vars — no new runtime deps (SC-008).
...
# ---------------------------------------------------------------------------
# Settings (UMMAYA_IPC_* env vars)
# ---------------------------------------------------------------------------


class HeartbeatSettings(BaseSettings):
    """Heartbeat knobs loaded from UMMAYA_IPC_* environment variables."""

    model_config = SettingsConfigDict(
        env_prefix="UMMAYA_IPC_",
        env_file=".env",
