...
// UMMAYA adaptation: unified 3-type envelope with UMMAYA i18n + color tokens.
...
const ERROR_COLOR: Record<ErrorEnvelopeT['type'], string> = {
  llm: '#a78bfa',      // purple (UMMAYA brand / LLM layer)
...
export type ErrorEnvelopeProps = {
  ...
  onRetry?: () => void;
  /** Locale override — falls back to UMMAYA_TUI_LOCALE env var */
  locale?: 'ko' | 'en';
};
