...
_KEY_PRESENT = bool(os.environ.get("KOSMOS_DATA_GO_KR_API_KEY"))


def _skip_if_no_key() -> None:
    if not _KEY_PRESENT:
        pytest.skip("KOSMOS_DATA_GO_KR_API_KEY not set — skipping live test")
...
class TestKmaCurrentObservationLive:
    ...
    async def test_seoul_current_observation(self) -> None:
        ...
        from kosmos.tools.kma.kma_current_observation import KmaCurrentObservationInput, _call
...
class TestKmaShortTermForecastLive:
    ...
    async def test_seoul_short_term_forecast(self) -> None:
        ...
        from kosmos.tools.kma.kma_short_term_forecast import KmaShortTermForecastInput, _call
...
class TestKmaForecastFetchLive:
    ...
    async def test_busan_forecast_fetch_by_latlon(self) -> None:
        ...
        from kosmos.tools.kma.forecast_fetch import KmaForecastFetchInput, _call
...
class TestKmaPreWarningLive:
    ...
    async def test_nationwide_pre_warning(self) -> None:
        ...
        from kosmos.tools.kma.kma_pre_warning import KmaPreWarningInput, _call
