...
"""Micro-compact engine for KOSAX Context Assembly layer.
...
variant).  KOSAX v1 uses only the simpler content-clear approach.
"""
...
def _dedup_system_messages(
    ...
    In KOSAX the system message is the very first element in the list.
