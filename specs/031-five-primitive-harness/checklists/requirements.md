...
- [x] Scope is clearly bounded
  - Out of Scope (Permanent) enumerates 4 hard exclusions (UMMAYA-operated CA/HSM/VC issuer, inbound webhooks, reverse-engineered OPAQUE mocks, NIST AAL as primary axis). Deferred Items table lists 9 items with Target Epic/Phase and tracking status.
