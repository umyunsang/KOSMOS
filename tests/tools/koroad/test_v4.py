...
2-digit + 3-digit wire param scheme confirmed by evidence:
  /tmp/ummaya-evidence/koroad-mohw-evidence.md § "siDo/guGun Code Scheme"
...
from ummaya.tools.koroad._short_references import KOROAD_SIDO_SHORT_REFERENCE
from ummaya.tools.koroad.accident_hazard_search import (
...
def test_sido_short_reference_inline_in_si_do_description() -> None:
    ...
    from ummaya.tools.koroad.koroad_accident_search import KoroadAccidentSearchInput
