...
| Primitive | `lookup` |
| Module | `src/kosax/tools/kma/kma_current_observation.py` |

## Envelope

**Input model**: `KmaCurrentObservationInput` defined at `src/kosax/tools/kma/kma_current_observation.py:38-77`.
...
**Output model**: `KmaCurrentObservationOutput` defined at `src/kosax/tools/kma/kma_current_observation.py:80-135`.
...
KOSAX: 2026년 4월 26일 오후 2시 기준 서울(격자 61, 125) 현재 날씨입니다. 기온은 18.5°C이며 현재 강수는 없습니다(강수유형: 없음). 풍속은 2.3 m/s, 습도는 55%입니다.
```
