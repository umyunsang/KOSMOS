...
//   --rate <n>          Events per second (default: UMMAYA_TUI_SOAK_EVENTS_PER_SEC or 100)
...
const RATE = parseInt(
  values.rate ?? process.env['UMMAYA_TUI_SOAK_EVENTS_PER_SEC'] ?? '100',
  10,
)
...
// For CI / offline mode, set UMMAYA_BACKEND_CMD=cat to get a trivial echo.
