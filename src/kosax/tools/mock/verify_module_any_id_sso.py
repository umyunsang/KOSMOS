...
from kosax.primitives.delegation import IdentityAssertion
from kosax.primitives.verify import AnyIdSsoContext, register_verify_adapter
...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.kosax.gov.kr/v1/verify/any_id_sso"
