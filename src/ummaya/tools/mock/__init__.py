"""Mock adapter tree for the active UMMAYA primitive harness.
...
Spec 031 US1 submit adapters (T027) — registered with ummaya.primitives.submit
on import:
...
import ummaya.tools.mock.submit_module_gov24_minwon  # noqa: F401, E402
import ummaya.tools.mock.submit_module_hometax_taxreturn  # noqa: F401, E402
import ummaya.tools.mock.submit_module_public_mydata_action  # noqa: F401, E402
...
from ummaya.tools.mock import (  # noqa: F401, E402  # noqa: F401, E402
