...
def _make_thinking_only_llm_client():
    ...
    """
    from kosax.llm.models import StreamEvent  # noqa: PLC0415
...
def _stub_prompt_loader(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with contextlib.suppress(ImportError):
        import kosax.context.prompt_loader as pl_mod  # noqa: PLC0415
...
async def test_thinking_channel_e2e_plumbing(
    ...
    import kosax.llm.client as llm_client_mod  # noqa: PLC0415
    import kosax.llm.config as llm_config_mod  # noqa: PLC0415
    ...
    from kosax.ipc.stdio import run as ipc_run  # noqa: PLC0415
