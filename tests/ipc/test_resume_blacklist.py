...
from kosax.ipc.frame_schema import ResumeRejectedFrame, ResumeResponseFrame
from kosax.ipc.resume_manager import RejectionReason, ResumeManager
...
def _resume(
    ...
    *,
    ...
    from kosax.ipc.frame_schema import ResumeRequestFrame
