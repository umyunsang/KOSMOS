...
| 한국어 LLM | 미정(범용) | 자체 모델 | EXAONE 4.0-32B (K-EXAONE) |
...
### 6-2. 한국어 LLM 벤치마크 (K-EXAONE 4.0-32B)
...
| K-EXAONE 4.0-32B KMMLU-Redux (Reasoning) | 72.7% | HuggingFace 모델 카드 |
