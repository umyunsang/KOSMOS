...
// (`Welcome to KOSAX` mirrors CC's `Welcome to Claude Code`) — prior
...
describe('WelcomeV2', () => {
  it('renders the Korean welcome header + kosaxCore cluster (shimmer on)', () => {
    ...
    expect(frame).toContain('Welcome to KOSAX')
