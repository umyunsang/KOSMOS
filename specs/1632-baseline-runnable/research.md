...
|---|---|---|---|
| 1 | Anthropic-only dead code 제거 | [#1633](https://github.com/umyunsang/KOSAX/issues/1633) | OPEN |
| 2 | FriendliAI 엔드포인트 연결 · 세션 JSONL 저장 | [#1633](https://github.com/umyunsang/KOSAX/issues/1633) | OPEN |
| 3 | Tool system wiring · 4 primitive · Python stdio MCP | [#1634](https://github.com/umyunsang/KOSAX/issues/1634) | OPEN |
| 4 | UI L2 컴포넌트 구현 | [#1635](https://github.com/umyunsang/KOSAX/issues/1635) | OPEN |
| 5 | Plugin DX Full 5-tier | [#1636](https://github.com/umyunsang/KOSAX/issues/1636) | OPEN |
| 6 | Docs/API specs + 종단간 smoke | [#1637](https://github.com/umyunsang/KOSAX/issues/1637) | OPEN |
| 7 | Coordinator · KAIROS · SSH · BG sessions · bridge mode | [#1633](https://github.com/umyunsang/KOSAX/issues/1633) | OPEN |
| 8 | Telemetry sinks 재연결 | [#1633](https://github.com/umyunsang/KOSAX/issues/1633) | OPEN |
| 9 | GrowthBook analytics · refresh·growthbook·* · services/analytics/* | [#1633](https://github.com/umyunsang/KOSAX/issues/1633) | OPEN |
...
**Alternatives considered**:
- **`src/entrypoints/kosax-main.tsx` 신설**: CC `src/entrypoints/cli.tsx`, `init.ts`
