...
export const UI_L2_SLASH_COMMANDS: readonly SlashCommandCatalogEntryT[] = [
  ...
  },
  {
    name: '/login',
    group: 'session',
    description_ko: 'FriendliAI API 키를 UMMAYA_FRIENDLI_TOKEN로 등록합니다',
    description_en: 'Register FriendliAI API key as UMMAYA_FRIENDLI_TOKEN',
    arg_signature: null,
    hidden: false,
  },
  {
    name: '/logout',
    group: 'session',
    description_ko: '저장된 FriendliAI API 키를 제거합니다',
    description_en: 'Remove the stored FriendliAI token',
    arg_signature: null,
    hidden: false,
  },
  {
