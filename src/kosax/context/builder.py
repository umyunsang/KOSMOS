...
from kosax.context.models import (
    AssembledContext,
    ContextLayer,
    SystemPromptConfig,
)
...
class ContextBuilder:
    ...
    def build_turn_attachment(
        ...
        from kosax.context.attachments import AttachmentCollector  # noqa: PLC0415
    ...
    def build_assembled_context(
        ...
        # --- Budget (US4) ---
        from kosax.context.budget import BudgetEstimator  # noqa: PLC0415
    ...
    async def maybe_compact_history(
        ...
        """
        from kosax.context.auto_compact import AutoCompactor  # noqa: PLC0415
    ...
    def _estimate_tool_defs_tokens(self, defs: list[dict[str, object]]) -> int:
        ...
        from kosax.engine.tokens import estimate_tokens  # noqa: PLC0415
