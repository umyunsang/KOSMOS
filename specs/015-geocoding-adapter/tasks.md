...
- [ ] T001 Create module directory and `__init__.py` at `src/kosax/tools/geocoding/__init__.py`
- [ ] T002 [P] Implement Kakao HTTP client with Pydantic models in `src/kosax/tools/geocoding/kakao_client.py`
- [ ] T003 [P] Implement region-name-to-code mapping in `src/kosax/tools/geocoding/region_mapping.py`
- [ ] T004 [P] Add Lambert Conformal Conic `latlon_to_grid()` to `src/kosax/tools/kma/grid_coords.py`
...
- [ ] T010 [US1] Implement `address_to_region` adapter (Input/Output models, `_resolve`, `_call`, `GovAPITool`, `register()`) in `src/kosax/tools/geocoding/address_to_region.py`
...
- [ ] T013 [US2] Implement `address_to_grid` adapter (Input/Output models, `_resolve_from_kakao`, `_fallback_local_lookup`, `_call`, `GovAPITool`, `register()`) in `src/kosax/tools/geocoding/address_to_grid.py`
...
- [ ] T014 [US3] Register both tools in `src/kosax/tools/register_all.py` (import + call, update docstring count to 9)
...
**Independent Test**: `KOSAX_KAKAO_API_KEY= uv run pytest tests/tools/geocoding/` passes with zero failures.
...
- [ ] T021 [P] Update `src/kosax/tools/geocoding/__init__.py` with re-exports and module docstring
...
Task: "Implement Kakao HTTP client in src/kosax/tools/geocoding/kakao_client.py"
Task: "Implement region mapping in src/kosax/tools/geocoding/region_mapping.py"
Task: "Add latlon_to_grid() to src/kosax/tools/kma/grid_coords.py"
