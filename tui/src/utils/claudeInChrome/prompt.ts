export const BASE_CHROME_PROMPT = `# UMMAYA in Chrome browser automation
...
/**
 * Minimal hint about UMMAYA in Chrome skill availability. This is injected at startup when the extension is installed
