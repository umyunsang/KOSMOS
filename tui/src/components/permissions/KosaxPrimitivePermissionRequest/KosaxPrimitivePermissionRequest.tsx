...
// Spec 2294 — KosaxPrimitivePermissionRequest component.
//
// Renders the KOSAX permission gauntlet for the active reserved primitives:
...
import { aalToLayer, type KosaxPrimitive } from '../../../utils/permissions/aalToLayer.js'
...
export type KosaxPrimitivePermissionRequestProps = {
...
export function KosaxPrimitivePermissionRequest({
  primitive,
  toolName,
  ...
  workerBadge,
  onDecision,
}: KosaxPrimitivePermissionRequestProps): React.ReactNode {
