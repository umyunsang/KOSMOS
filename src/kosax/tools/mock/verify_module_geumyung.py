...
from kosax.primitives.verify import GeumyungModuleContext, register_verify_adapter
...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.kosax.gov.kr/v1/verify/geumyung"
