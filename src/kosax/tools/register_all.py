...
"""Central registration entry point for all KOSAX government API tools.
...
def register_all_tools(registry: ToolRegistry, executor: ToolExecutor) -> RoutingIndex:
    ...
    from kosax.tools.kma.kma_current_observation import register as reg_kma_obs
    from kosax.tools.kma.kma_pre_warning import register as reg_kma_pre_warning
    from kosax.tools.kma.kma_short_term_forecast import register as reg_kma_stf
    from kosax.tools.kma.kma_ultra_short_term_forecast import register as reg_kma_ustf
    from kosax.tools.kma.kma_weather_alert_status import register as reg_kma_alert
    ...
    from kosax.tools.mohw.welfare_eligibility_search import register as reg_mohw
    from kosax.tools.mvp_surface import register_mvp_surface
    from kosax.tools.nfa119.emergency_info_service import register as reg_nfa
    from kosax.tools.nmc.emergency_search import register as reg_nmc

    # Register MVP LLM-visible core surface first (FR-001, SC-003)
    register_mvp_surface(registry)
    import kosax.tools.mock  # noqa: F401 — registers all mock surfaces in production
    ...
    from kosax.tools.discovery_bridge import bridge_per_primitive_registries
