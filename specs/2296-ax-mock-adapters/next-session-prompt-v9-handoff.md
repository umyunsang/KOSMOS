...
- `src/ummaya/primitives/verify.py` — 11-arm AuthContext union + 11 family literal values
- `src/ummaya/tools/registry.py:68-93` — 18-label `PublishedTier` Literal (5 신규 추가됨)
...
git worktree add ../UMMAYA-w-2298 -b 2298-system-prompt-rewrite
cd ../UMMAYA-w-2298
