...
"""ummaya.ipc — IPC frame schema and stdio transport for the TUI ↔ backend bridge.

Public surface::

    from ummaya.ipc import IPCFrame, run_stdio_loop, write_frame
    from ummaya.ipc import (
...
from ummaya.ipc.stdio import run as run_stdio_loop
from ummaya.ipc.stdio import write_frame
