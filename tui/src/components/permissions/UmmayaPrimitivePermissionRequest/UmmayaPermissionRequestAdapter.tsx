...
// Epic 1 finish — CC switch arm adapter for UMMAYA primitives.
//
...
// UMMAYA adaptation: wraps onAllow / onReject callbacks to satisfy both the
//   CC pipeline (toolUseConfirm.onAllow / onReject) and the UMMAYA modal API
//   (onDecision). receipt_id is surfaced in the footer via
//   context.ummaya_receipt_id injected by the backend echo frame handler.

import React, { useCallback } from 'react'
import { resolveAdapter } from '../../../services/api/adapterManifest.js'
import type { PermissionRequestProps } from '../PermissionRequest.js'
import type { PrimitiveDecision } from './UmmayaPrimitivePermissionRequest.js'
import { UmmayaPrimitivePermissionRequest } from './UmmayaPrimitivePermissionRequest.js'
...
/**
 * Maps a UMMAYA PrimitiveDecision to the CC `onAllow` / `onReject` callbacks.
