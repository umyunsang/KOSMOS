...
KOSAX handler: src/kosax/llm/client.py:788-802.
...
def fake_friendli_token(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("KOSAX_FRIENDLI_TOKEN", "test-token-2521")
    monkeypatch.setenv("KOSAX_FRIENDLI_BASE_URL", "https://api.test.invalid/v1")
    monkeypatch.setenv("KOSAX_FRIENDLI_MODEL", "LGAI-EXAONE/K-EXAONE-236B-A23B")
...
async def test_reasoning_content_forwarded_as_thinking_delta(
    ...
    # sub-chunks of ``KOSAX_LLM_STREAM_CHUNK_MAX_CHARS``. The contract is
