...
Public API (legacy — FR-012/FR-013 backwards compatibility)::
    ...
    from ummaya.observability import MetricsCollector, ObservabilityEvent

Public API (OTel tracing — spec 021)::

    from ummaya.observability import setup_tracing, TracingSettings, filter_metadata
