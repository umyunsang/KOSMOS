...
class TestNfaLayer3Gate:
    ...
    when KOSAX_DATA_GO_KR_API_KEY is absent (which is the CI equivalent).
...
class TestNfaToolMetadata:
    ...
    def test_tool_constants(self) -> None:
        # KOSAX-invented Spec 033/024/025 fields removed in Epic δ #2295:
...
class TestNfaVariantCFlatResponse:
    ...
    def test_parse_items_variant_c_flat_with_data(self) -> None:
        ...
        from kosax.tools.nfa119.emergency_info_service import _parse_items
    ...
    def test_parse_response_variant_c_flat_empty(self) -> None:
        ...
        from kosax.tools.nfa119.emergency_info_service import _parse_response
