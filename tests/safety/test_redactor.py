...
"""T017 / T019 / T020 — Tests for run_redactor() in kosax.safety._redactor.
...
def test_redactor_fixture(fixture: dict) -> None:
    ...
    if is_invalid_luhn_card:
        ...
        from kosax.safety._patterns import _PII_PATTERNS  # noqa: PLC0415
...
@pytest.mark.skipif(
    os.environ.get("KOSAX_SKIP_PERF") == "1",
    reason="KOSAX_SKIP_PERF=1 — performance gates disabled on constrained runners",
)
