...
- [P] **T014** — Patch `src/kosax/tools/kma/forecast_fetch.py` so that `meta.fetched_at`
...
- [ ] **T016** — Run `uv run pytest src/kosax/tools/` — zero regression.
...
- [P] **T031** — Add `kosax.tool.stage` span attribute (thinking/fetch/parse).
