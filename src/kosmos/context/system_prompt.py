...
class SystemPromptAssembler:
    ...
    def _session_guidance_section(self) -> str:
        ...
        return (
            ...
            "Concrete example: for \"강남역 근처 사고 정보\", first call address_to_region "
            "with query \"강남역\" to obtain si_do and gu_gun, then call the KOROAD "
            "accident search tool with those returned codes. Always use tools for "
            "location-based factual queries — even when you recognize the place name."
        )
