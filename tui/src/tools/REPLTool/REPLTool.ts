...
// UMMAYA-1633 P2 / UMMAYA-1978 T009 — stub-noop tool.
//
// Original CC: `tui/src/tools/REPLTool/REPLTool.ts` — Anthropic's Python REPL
// tool for the Code Interpreter feature. UMMAYA does not ship a Python REPL
...
export const REPLTool = {
  ...
  description: 'UMMAYA-1978: REPLTool not active in citizen TUI.',
