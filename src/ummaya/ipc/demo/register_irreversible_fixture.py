...
Spec 032 ``quickstart.md § 4.1``::
    ...
    uv run python -m ummaya.ipc.demo.register_irreversible_fixture
...
``ummaya.primitives.submit`` in-process dispatch table.  This mirrors the
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        import ummaya.tools.mock.mydata.welfare_application as welfare
