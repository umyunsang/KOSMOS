...
"""Unit tests for the KOSAX Query Engine preprocessing pipeline.
...
from kosax.engine.preprocessing import (
...
def test_stage_microcompact_system_messages_never_modified() -> None:
    ...
    original = "You are   KOSAX  assistant."
