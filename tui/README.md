...
The terminal user interface for KOSAX — a Korean public-service multi-agent harness ported from Claude Code 2.1.88 onto the FriendliAI/K-EXAONE backend.
...
UI L2 owns two new USER-tier paths under `~/.kosax/memdir/user/`:
