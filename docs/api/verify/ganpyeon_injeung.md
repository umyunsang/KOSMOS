...
| Primitive | `verify` |
| Module | `src/kosax/tools/mock/verify_ganpyeon_injeung.py` |
...
**Output model**: `GanpyeonInjeungContext` defined at `src/kosax/primitives/verify.py:154–167`.
...
KOSAX: 카카오 간편인증 (AAL2) 인증이 확인되었습니다. 인증 시각: 2026-04-19 09:00 UTC, 세션 참조: mock-ganpyeon-ref-001.
```
