...
/** Placeholder for APIUserMessage from KOSAX sdk-compat */
export const APIUserMessagePlaceholder = lazySchema(() => z.unknown())

/** Placeholder for APIAssistantMessage from KOSAX sdk-compat */
export const APIAssistantMessagePlaceholder = lazySchema(() => z.unknown())

/** Placeholder for RawMessageStreamEvent from KOSAX sdk-compat */
