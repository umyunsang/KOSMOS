...
```markdown
# TUI Component Catalog — CC → KOSAX Verdict Matrix

**Epic**: M #1310
**Branch at authoring**: 034-tui-component-catalog
**Commit at authoring**: <KOSAX repo HEAD at merge>
...
```markdown
| # | CC source path | Files | Family | Verdict | Owning Epic | KOSAX target | Rationale | Evidence | Accessibility gate | Task sub-issue | Feature commit | Merge commit |
|---|---|---:|---|---|---|---|---|---|---|---|---|---|
```
...
| `KOSAX target` | PORT/REWRITE only | absolute path under `tui/src/` (creating directories allowed) |
