...
(``kosax.primitives.submit.submit()``); this module only declares the requirement.
...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.kosax.gov.kr/v1/submit/traffic/fine-pay"
