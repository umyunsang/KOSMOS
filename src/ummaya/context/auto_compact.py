...
"""Auto-compact trigger for UMMAYA Context Assembly layer.
...
from ummaya.context.micro_compact import (
    _count_total_tokens,  # noqa: PLC2701
    micro_compact,
)
from ummaya.context.session_compact import session_compact
...
def _aggressive_truncate(
    ...
    from ummaya.context.micro_compact import _protected_slice_start  # noqa: PLC0415
    from ummaya.context.session_compact import _SUMMARY_HEADER  # noqa: PLC0415
