...
- **Alternatives considered**:
  ...
  - *LangGraph RetryPolicy per-node*: node-level retry assumes a graph runtime UMMAYA does not yet use at Layer 1. Rejected.
