...
describe('Epic #1633 T041 — US3 invariant: CC dead-code directories removed', () => {
  test.each([
    ...
    // UMMAYA no-op stubs for the byte-copied services/api/claude.ts. They
    ...
    // companion "stub files restored as UMMAYA no-ops" describe block
...
describe('Epic #1633 T041 — US3 invariant: stub files restored as UMMAYA no-ops', () => {
  ...
  test.each([
    ...
    // restored services/api/claude.ts. Each is a UMMAYA no-op that
    ...
    // never execute under UMMAYA's stdio bridge routing.
