...
"""End-to-end integration tests for ``ummaya.plugins.installer.install_plugin``.
...
``~/.ummaya`` filesystem (``UMMAYA_PLUGIN_*`` env vars + monkeypatched
...
def _manifest_dict(*, plugin_id: str = "demo_plugin", tier: str = "live") -> dict[str, Any]:
    ...
    return {
        ...
        "dpa_reference": None,
        "slsa_provenance_url": (
            "https://github.com/ummaya-plugin-store/ummaya-plugin-demo/"
