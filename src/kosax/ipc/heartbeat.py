...
KOSAX_IPC_* env vars — no new runtime deps (SC-008).
...
# ---------------------------------------------------------------------------
# Settings (KOSAX_IPC_* env vars)
# ---------------------------------------------------------------------------


class HeartbeatSettings(BaseSettings):
    """Heartbeat knobs loaded from KOSAX_IPC_* environment variables."""

    model_config = SettingsConfigDict(
        env_prefix="KOSAX_IPC_",
        env_file=".env",
