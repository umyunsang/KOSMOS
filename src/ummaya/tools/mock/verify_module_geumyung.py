...
from ummaya.primitives.verify import GeumyungModuleContext, register_verify_adapter
...
_ACTUAL_ENDPOINT: Final = "https://api.gateway.ummaya.gov.kr/v1/verify/geumyung"
