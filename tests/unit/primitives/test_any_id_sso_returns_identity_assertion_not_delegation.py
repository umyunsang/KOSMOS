...
def test_any_id_sso_returns_identity_assertion_not_delegation() -> None:
    ...
    """
    from ummaya.primitives.verify import AnyIdSsoContext
    from ummaya.tools.mock.verify_module_any_id_sso import invoke
...
def test_downstream_submit_rejects_identity_assertion(tmp_path) -> None:
    ...
    """
    from ummaya.tools.mock.verify_module_any_id_sso import invoke as any_id_sso_invoke
...
def test_any_id_sso_is_registered() -> None:
    ...
    import ummaya.tools.mock.verify_module_any_id_sso  # noqa: F401
