...
// KOSAX-original (no upstream analog — Claude Code is not a child process).
//
...
// FR-004).
//
// All KOSAX_*_KEY/SECRET/TOKEN/PASSWORD values are already redacted by
