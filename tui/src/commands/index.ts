// KOSAX-original command registry builder.
...
/**
 * Build and return the default KOSAX command registry containing:
 *   /save              — save current session
 *   /sessions          — list sessions
 *   /resume            — resume session by id  (alias: /continue)
 *   /new               — start a new session
 *   /plugin            — install / list / uninstall plugins (Spec 1636 P5)
 *   /migrate-sessions  — migrate CC-workspace JSONL sessions to KOSAX memdir
 */
