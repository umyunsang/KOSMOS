...
**Project Type**: Library extension — modifies existing `src/kosax/ipc/` + `tui/src/ipc/` packages. No new top-level package.
...
```text
src/kosax/ipc/                                     # EXTEND existing package
