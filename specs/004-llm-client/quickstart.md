...
export UMMAYA_FRIENDLI_BASE_URL="https://api.friendli.ai/v1"
export UMMAYA_FRIENDLI_MODEL="dep89a2fde0e09"
export UMMAYA_LLM_SESSION_BUDGET="100000"
```
...
```python
from ummaya.llm import LLMClient, ChatMessage
...
```python
from ummaya.llm import LLMClient, ChatMessage, ToolDefinition, FunctionSchema
...
# Live tests are planned for Phase 2 (requires valid UMMAYA_FRIENDLI_TOKEN)
