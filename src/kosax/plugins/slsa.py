...
* The vendored-binary discovery rule: ``--vendor-slsa-from <path>``
  override → ``KOSAX_PLUGIN_VENDOR_ROOT/slsa-verifier/<platform>/slsa-verifier``
    ...
    *,
    ...
    Args:
        ...
        source_uri: Expected source URI claim
            (e.g. ``github.com/kosax-plugin-store/kosax-plugin-<name>``).
    ...
    if not binary.is_file():
        ...
        return SLSAVerificationResult(
            ...
            stderr_tail=(
                ...
                "platform-specific binary into KOSAX_PLUGIN_VENDOR_ROOT."
            ),
            exit_code=-1,
        )
