...
// KOSAX-original — process-scoped FriendliAI API-key auth.
//
// Mirrors Claude Code's login/logout lifecycle shape, but KOSAX does not use
...
export const FRIENDLI_PRIMARY_ENV = 'KOSAX_FRIENDLI_TOKEN'
export const FRIENDLI_SESSION_ENV = 'KOSAX_FRIENDLI_SESSION_ACTIVE'
