...
"""High-level session manager for the UMMAYA REPL.
...
from ummaya.llm.models import ChatMessage, ToolCall
...
class SessionManager:
    """Manages a single UMMAYA session with JSONL persistence.
    ...
    async def new_session(self) -> SessionMetadata:
        ...
        :func:`~ummaya.session.store.create_session` is now lazy — it returns
        ...
        that :meth:`resume_session` and :func:`~ummaya.session.store.list_sessions`
