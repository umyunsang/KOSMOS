...
The KOSAX primitive design isolates verify / submit mock adapters
in per-primitive ``_ADAPTER_REGISTRY`` dicts (``kosax.primitives.{verify,
submit}``). The main :class:`kosax.tools.registry.ToolRegistry` and
...
synthesising lightweight :class:`kosax.tools.models.GovAPITool` wrappers for
...
Called once from :func:`kosax.tools.register_all.register_all_tools`
immediately after ``import kosax.tools.mock`` so all per-primitive registries
are populated.
"""
...
# name into kosax.primitives.verify._ADAPTER_REGISTRY without an
...
_VERIFY_FAMILIES: list[dict[str, Any]] = [
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/modid",
    ...
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/kec",
    ...
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/geumyung",
    ...
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/simple",
        "policy_authority": "https://www.kftc.or.kr/",
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/sso",
    ...
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/gongdong",
    ...
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/geumyung-injeungseo",
        "policy_authority": "https://www.kftc.or.kr/",
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/ganpyeon",
        "policy_authority": "https://www.kftc.or.kr/",
        "scope_rules": (
    ...
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/mobile-id",
    ...
    },
    {
        ...
        "endpoint": "https://api.gateway.kosax.gov.kr/v1/verify/mydata",
...
def bridge_per_primitive_registries(registry: ToolRegistry) -> int:
    ...
    Must be called AFTER ``import kosax.tools.mock`` so all per-primitive
...
def _bridge_submit(registry: ToolRegistry) -> int:
    try:
        from kosax.primitives.submit import _ADAPTER_REGISTRY as _SUBMIT_REG_LOCAL
    except ImportError:
        return 0
